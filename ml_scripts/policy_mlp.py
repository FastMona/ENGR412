...
see ml_scripts/dataset.py's require_multi_upper docstring. If azimuth really is negligible here
...
def _c_float(v: float) -> str:
    ...
    here in ENGR412-mlp/ml_scripts/policy_mlp.py (confirmed by testing .8g formatting on
