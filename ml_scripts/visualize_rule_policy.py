...
Usage:
    python3 ml_scripts/visualize_rule_policy.py                          # default RPM samples, rule policy
    python3 ml_scripts/visualize_rule_policy.py --rpms 100 500 899 900 1300
    python3 ml_scripts/visualize_rule_policy.py --out ml_scripts/artifacts/rule_policy_check.png
"""
